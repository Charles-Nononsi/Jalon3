...
public class CategoryRepositoryImpl implements CategoryRepository {
  ...
  private static final String SQL_CREATE = "INSERT INTO ET_CATEGORIES (CATEGORY_ID, USER_ID, TITLE) VALUES(NEXTVAL('ET_CATEGORIES_SEQ'), ?, ?, ?) ";
  ...
  @Override
  public Integer create(Integer userId, String title) throws EtBadRequestException {
    try {
